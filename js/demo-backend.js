    ...
    _seed() {
      ...
      return {
        ...
        TAREAS: [
          ...
          { ID: 'TAR-003', Categoria: 'Soporte de Modulos Starsoft', Titulo: 'Migración de cuenta de Claude', Descripcion: '', Observaciones: 'Pendiente desde hace días', Tipo: '', 'Asignado a': 'Tito Técnico', 'Asignado por': 'Lía Líder', Estado: 'Pendiente', Prioridad: 'Alta', 'Fecha inicio': dias(4), 'Fecha limite': dias(2), 'Ticket relacionado': '', 'Fecha completada': '', 'En calendario': 'No', 'Event ID': '' },
        ],
        EQUIPOS: [
